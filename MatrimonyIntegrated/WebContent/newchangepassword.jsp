...
<fmt:setBundle basename="com.tcs.matrimony.resources.ApplicationResources"/>
	...
	<bean:write name="msg"/><br>
	 ...
	 <div class="toogle_wrap">
            <div class="trigger"><a name="relinfo"><fmt:message key="profile.label.religion"></fmt:message></a>&nbsp;&nbsp;&nbsp;&nbsp;<span id="edit1"></span></div>
                	...
                	<tr>
                        ...
                        <td valign="top">
                        	<table width="100%" border="0" height="200px">
                            	<tr>
                                	<td width="150px"><fmt:message key="login.label.oldpwd"></fmt:message></td>
                                    <td><fmt:message key="common.label.colon"></fmt:message></td>
                                    <td id="tab_ans"><html:password property="password" name="ChangePwdVal"/></td>
                                    <td width="200px"><html:errors property="password"/></td>
                                </tr>
                                <tr>
                                	<td><fmt:message key="login.label.newpwd"></fmt:message></td>
                                    <td><fmt:message key="common.label.colon"></fmt:message></td>
                                    <td id="tab_ans"><html:password property="newpwd" name="ChangePwdVal"/></td>
                                    <td width="200px"><html:errors property="newpwd"/></td>
                                </tr>
                                <tr>
                                	<td><fmt:message key="login.label.renewpwd"></fmt:message></td>
                                    <td><fmt:message key="common.label.colon"></fmt:message></td>
                                    <td id="tab_ans"><html:password property="renewpwd" name="ChangePwdVal"/></td>
                                    <td width="200px"><html:errors property="renewpwd"/></td>
                                </tr>
								<tr>
                                	<td></td>
                                	<td></td>
                                    <td><html:submit><fmt:message key="login.label.button.submit"></fmt:message></html:submit></td>
                                    <td></td>
                                </tr>                               
                            </table>
                        </td>
...
<div  class="side-content" id="side-content">
    <h2>Settings</h2>
        ...
        <ul>
            ...
            <li><html:link page="/pages/userid.jsp"><fmt:message key="settings.label.deactivate"></fmt:message></html:link></li>
            <li><html:link page="/pages/changepassword.jsp"><fmt:message key="settings.label.changepwd"></fmt:message></html:link></li>
            <li><html:link page="/pages/resetsecurity.jsp"><fmt:message key="settings.label.changesec"></fmt:message></html:link></li>
        </ul>
