...
<div id="content"><div class="inner_copy"></div>  
    ...
    <div id="right_content">  
        ...
        <div class="toogle_wrap">
            <div class="trigger"><a name="relinfo"><fmt:message key="profile.label.religion"></fmt:message></a></div>
			...
			<hr color="#FFFFFF"/>
        		<table id="aboutme" border="0">
                        ...
                        <td valign="top">
                        	<table width="100%" border="0" height="200px">
                                ...
                                <tr>
                                    ...
                                    <td id="tab_ans">
                                    	<select>
                                        	<option >caste1</option>
                                            <option >caste2</option>
                                            <option >caste3</option>
                                            <option >caste4</option>
                                        </select>
                                    </td>
                                    <td></td>
                                </tr>
                                <tr>
                                    ...
                                    <td><fmt:message key="common.label.colon"></fmt:message></td>
                                    <td id="tab_ans"><html:text property="bean_gothram" name="RegisterForm4"></html:text></td>
                                      <td width="200px"><html:errors property="bean_gothram"/></td>
                                </tr>
                                <tr>
                    ...
                    <tr><td></td><td colspan="3" ><html:submit property="action" value="updatereligiousdetails"></html:submit></td><td></td></tr>
                </table>
