...
<div id="content"><div class="inner_copy"></div> 
    ...
    <div id="right_content">  
        ...
        <div class="toogle_wrap">
            <div class="trigger"><a name="hobbies"><fmt:message key="profile.label.h"></fmt:message></a></div>
			...
			<hr color="#FFFFFF"/>
        		<table id="aboutme" border="0">
                	<tr>
                    	<td>
                    		<html:textarea cols="75" rows="6" property="bean_hobbies" name="RegisterForm4" style="resize:none;overflow:hidden;"></html:textarea>
                    	</td>
                           <td width="200px"><html:errors property="bean_hobbies"/></td>
                    </tr>
                    <tr>
	<td colspan="3" align="center">
	<html:submit property="action" value="updatehobbies"></html:submit></td>
	</tr>
                </table>
