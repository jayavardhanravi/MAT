...
<div id="content"><div class="inner_copy"></div>  
    ...
    <div id="right_content">  
        ...
        <div class="toogle_wrap1">
            <div class="trigger"><a name="par_relinfo"><fmt:message key="profile.label.preligion"></fmt:message><fmt:message key="profile.label.ppref"></fmt:message></a></div>
                        ...
                        <td valign="top">
                        	<table width="100%" border="0" height="200px">
                            	<tr>
                                    ...
                                    <td id="tab_ans">
                                    	<html:select property="bean_preligion" name="RegisterForm4">
                                            ...
                                            <html:option value="Jewish">Jewish</html:option>
                                        </html:select>
                                    </td>
                                    <td width="100px"></td>
                                </tr>
                                <tr>
                                    ...
                                    <td><fmt:message key="common.label.colon"></fmt:message></td>
                                    <td id="tab_ans">
                                    <html:text property="bean_pcaste" name="RegisterForm4"></html:text>
                                    </td>
                                      <td width="200px"><html:errors property="bean_pcaste"/></td>
                                </tr>
                       
                                <tr>
                                	<td><fmt:message key="profile.label.pstar"></fmt:message></td>
                                    <td><fmt:message key="common.label.colon"></fmt:message></td>
                                    <td id="tab_ans">
                                    	<html:text property="bean_pstar" name="RegisterForm4"></html:text>
                                    </td>
                                   <td width="200px"><html:errors property="bean_pstar"/></td>
                                ...
                                <tr>
                                    ...
                                    <td><fmt:message key="common.label.colon"></fmt:message></td>
                                    <td id="tab_ans">
                                    	<html:radio property="bean_pmanglik" name="RegisterForm4" value="yes"/>Yes
                                        <html:radio property="bean_pmanglik"  name="RegisterForm4" value="no"/>No
                                    </td>
                                    <td></td>
                                </tr>
                            </table>
	...
	<html:submit property="action" value="updatepartnersreligiousdetails"></html:submit>
	</td><td></td></tr>
                </table>
