...
<div id="content"><div class="inner_copy"></div>
    ...
    <div id="right_content">  
        ...
        <div class="toogle_wrap1">
            <div class="trigger"><a name="par_basicdetails"><fmt:message key="profile.label.pprefbasic"></fmt:message><fmt:message key="profile.label.ppref"></fmt:message></a></div>
                        ...
                        <td valign="top">
                        	<table width="100%" border="0" height="200px">
                            	<tr>
                                    ...
                                    <td id="tab_ans">
                                    	<html:text property="bean_page" name="RegisterForm4" style="width:40px;"></html:text>
                                    </td>
                                      <td width="200px"><html:errors property="bean_interests"/></td>
                                </tr>
                                <tr>
                                	<td><fmt:message key="profile.label.pheight"></fmt:message></td>
                                    <td><fmt:message key="common.label.colon"></fmt:message></td>
                                    <td id="tab_ans">
		<html:text property="bean_pheight" name="RegisterForm4" style="width:40px;"></html:text>(in centimeters)
		</td>
                                      <td width="200px"><html:errors property="bean_interests"/></td>
                                </tr>
                                <tr>
                                    ...
                                    <td><fmt:message key="common.label.colon"></fmt:message></td>
                                    <td id="tab_ans">
                                    	<html:select property="bean_mStatus" name="RegisterForm4">
 	 <html:option value="single"><fmt:message key="register.label.single"></fmt:message></html:option>
              	  ...
              	  <html:option value="widower"><fmt:message key="register.label.widower"></fmt:message></html:option>
                                ...
                                <tr>
                                    ...
                                    <td><fmt:message key="common.label.colon"></fmt:message></td>
                                    <td id="tab_ans">
                                    	<input  type="radio" name="radio_family" checked="checked"/>Vegetarian
                                        <input  type="radio" name="radio_family"/>Non-Vegetarian
                                        <input  type="radio" name="radio_family"/>Both Veg/Non-Veg
                                    </td>
                                    <td ></td>
                                </tr>
                                <tr>
                                    ...
                                    <td id="tab_ans">
                                    	<select>
                                        	<option value="1" selected="selected">Telugu</option>
	...
	<html:submit property="action" value="updatepartnersbasicdetails"></html:submit>
	</td><td></td></tr>
                </table>
