...
<fmt:setLocale value="en_US"/>
<fmt:setBundle basename="com.tcs.matrimony.resources.ApplicationResources"/>
	<html:form action="/resetsecurity">
	<html:messages id="msg" message="true">
	<bean:write name="msg"/><br>
	</html:messages><br/>
	
	 <div class="toogle_wrap">
            <div class="trigger"><a name="relinfo"><fmt:message key="settings.label.changesec"></fmt:message></a>&nbsp;&nbsp;&nbsp;&nbsp;<span id="edit1"></span></div>
                	...
                	<tr>
                        ...
                        <td valign="top">
                        	<table width="100%" border="0" height="200px">
                            	<tr>
                                	<td width="150px"><fmt:message key="register.label.security_Q"></fmt:message></td>
                                    <td><fmt:message key="common.label.colon"></fmt:message></td>
                                    <td id="tab_ans"><html:select property="security_Q">
  <html:option value="What is your School Name?"><fmt:message key="register.label.q1"></fmt:message></html:option>
                ...
                <html:option value="What is your Favorite Color?"><fmt:message key="register.label.q5"></fmt:message></html:option>
                                ...
                                <tr>
                                	<td><fmt:message key="register.label.security_A"></fmt:message></td>
                                    <td><fmt:message key="common.label.colon"></fmt:message></td>
                                    <td id="tab_ans"><html:text property="security_A"></html:text></td>
                                    <td width="200px"><html:errors property="security_A"/></td>
                                </tr>
                               
								<tr>
                                	<td></td>
                                	<td></td>
                                    <td><html:submit property="action" value="Reset Answer"></html:submit></td>
                                    <td></td>
                                </tr>                               
                            </table>
                        </td>
