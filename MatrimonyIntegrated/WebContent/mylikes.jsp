...
<div class="inner_copy"></div> 
	...
	<logic:iterate id="profiles" property="bean_al" name="NetworkForm">
	<li><c:set var="image" value="${profiles.profPhoto}"></c:set>
	<img src="${image}" width="150"  height="150"/><br/>
	<bean:write name="profiles" property="bean_userLike"></bean:write></li>
	</logic:iterate>		
