...
<div id="content"><div class="inner_copy"></div>
    ...
    <div id="right_content">  
        ...
        <div class="toogle_wrap">
            <div class="trigger"><a name="interests"><fmt:message key="profile.label.int"></fmt:message></a></div>
			...
			<hr color="#FFFFFF"/>
        		<table id="aboutme" border="0">
                	<tr>
                    	<td>
                    		<html:textarea cols="75" rows="6" property="bean_interests" name="RegisterForm4" style="resize:none;overflow:hidden;"></html:textarea>
                    	</td>
                       <td width="200px"><html:errors property="bean_interests"/></td>
                    </tr>
                    <tr><td colspan="2" align="center">
	<html:submit property="action" value="updateinterests"></html:submit>
	</td></tr>
                </table>
