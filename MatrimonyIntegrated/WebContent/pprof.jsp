...
<div id="content"><div class="inner_copy"></div>  
    ...
    <div id="right_content">  
        ...
        <div class="toogle_wrap1">
            <div class="trigger"><a name="par_profinfo"><fmt:message key="profile.label.pprefpro"></fmt:message><fmt:message key="profile.label.ppref"></fmt:message></a></div>
                        ...
                        <td valign="top">
                        	<table width="100%" border="0" height="200px">
                            	<tr>
                                    ...
                                    <td id="tab_ans">
                                    	<html:select property="bean_peducation" name="RegisterForm4"><html:option value="B.Tech/B.E">B.Tech/B.E</html:option>
			...
			<html:option value="Others">Others</html:option>
                                ...
                                <tr>
                                    ...
                                    <td><fmt:message key="common.label.colon"></fmt:message></td>
                                    <td id="tab_ans">
                                    <html:select property="bean_pocc" name="RegisterForm4"><html:option value="Engineer">Engineer</html:option>
			...
			<html:option value="Others">Others</html:option>
                                ...
                                <tr>
                                    ...
                                    <td><fmt:message key="common.label.colon"></fmt:message></td>
                                    <td id="tab_ans"><html:text property="bean_pannualsal" name="RegisterForm4" ></html:text></td>
                                    <td>(in Lakhs)</td>
                                       <td width="200px"><html:errors property="bean_pannualsal"/></td>
                                </tr>
                            </table>
                        </td>
                    </tr>
                     <tr><td></td><td colspan="3"  align="right">
	<html:submit property="action" value="updatepartnersprofessionaldetails"></html:submit>
	</td><td></td></tr>
                </table>
