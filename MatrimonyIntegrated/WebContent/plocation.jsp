...
<div id="content"><div class="inner_copy"></div>      
    ...
    <div id="right_content">  
        <div class="toogle_wrap2">
          ...
          <br/>
        <div class="toogle_wrap1">
            <div class="trigger"><a name="par_location"><fmt:message key="profile.label.location"></fmt:message><fmt:message key="profile.label.ppref"></fmt:message></a></div>
		...
		<td><fmt:message key="common.label.colon"></fmt:message></td>
                                    <td id="tab_ans">
                                    	<html:select property="bean_pcountry" name="RegisterForm4">
                                        	<html:option value="India">India</html:option>
                                            <html:option  value="Sri Lanka">SriLanka</html:option>
                                 ...
                                 <tr>
                                    ...
                                    <td><fmt:message key="common.label.colon"></fmt:message></td>
                                    <td id="tab_ans">
                                    	<html:select property="bean_pstate" name="RegisterForm4">
                                        	<html:option value="1">Andhra Pradesh</html:option>
                                            <html:option value="1">Maharastra</html:option>
                                            <html:option value="1">TamilNadu</html:option>
                                            <html:option value="1">Jammu & Kashmir</html:option>
                                        </html:select>
                                    </td>
                                    <td></td>
                                </tr>
                                <tr>
                                	<td><fmt:message key="profile.label.pplace"></fmt:message></td>
                                    <td><fmt:message key="common.label.colon"></fmt:message></td>
                                    <td id="tab_ans">
                                    	<html:select property="bean_pcity" name="RegisterForm4">
                                        	<html:option value="1">Hyderabad</html:option>
                                            <html:option value="1">Mumbai</html:option>
                                            <html:option value="1">Chennai</html:option>
                                            <html:option value="1">Jammu</html:option>
                                        </html:select>
                                    </td>
                                    <td></td>
                                </tr>                               
	...
	<html:submit property="action" value="updatepartnerslocationdetails"></html:submit>
	</td><td></td></tr>
                </table>
